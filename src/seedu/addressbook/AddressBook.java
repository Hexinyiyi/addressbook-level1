...
public class AddressBook {
    ...
    private static String executeSortAllPersonsInAddressBook() {
        ...
        ArrayList<HashMap<PersonProperty, String>> allPersonsCopy = new ArrayList<>(allPersons);
        Collections.sort(allPersonsCopy, new MapComparator(PersonProperty.NAME));
    ...
    */
    ...
    static class MapComparator implements Comparator<HashMap<PersonProperty, String>> {
        private final PersonProperty key;

        public MapComparator(PersonProperty key) {
            this.key = key;
        }
        public int compare(HashMap<PersonProperty, String> firstPerson,
                           HashMap<PersonProperty, String> secondPerson) {
            String firstPersonName = firstPerson.get(key);
            String secondPersonName = secondPerson.get(key);
